...
```mermaid
sequenceDiagram
    participant Sales as Outreach Team
    participant Prospect as Enterprise CTO / Head of AI
    
    Sales->>Prospect: Day 1: Send Initial Technical Pitch (Email / LinkedIn)
    Note over Prospect: Focus on Label Noise & 5 Disciplines
    
    Sales->>Prospect: Day 4: Send Follow-Up Value-Add (5-Discipline Framework PDF)
    Note over Prospect: Share DQA 8 Dimensions Checklist
    
    Sales->>Prospect: Day 8: Send Soft Break-Up Note
    Note over Prospect: Offer direct calendar booking link
```
