...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 relative overflow-hidden bg-[#0a0a0f] services-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="glass-panel p-8 md:p-12 rounded-2xl flex flex-col justify-between min-h-[220px]">
          <div>
            ...
            <p className="text-base md:text-lg font-sans text-slate-300 leading-relaxed italic">
              &ldquo;{t.quote}&rdquo;
            </p>
          </div>
          
          <div className="mt-8 flex items-center justify-between pt-6 border-t border-slate-805/60">
            <div>
              <div className="text-sm font-heading font-bold text-white">{t.author}</div>
              <div className="text-xs text-slate-500">{t.role}</div>
            </div>
            <div className="flex gap-2">
              <button onClick={prevTestimonial} className="p-2 rounded-lg bg-white/[0.02] border border-slate-800 text-slate-400 hover:text-white transition-colors">
                <ChevronLeft className="w-4 h-4" />
              </button>
              <button onClick={nextTestimonial} className="p-2 rounded-lg bg-white/[0.02] border border-slate-800 text-slate-400 hover:text-white transition-colors">
